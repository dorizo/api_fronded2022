...
import { ADD_PRODUCT, DELETE_PRODUCT, GET_PRODUCTS, UPDATE_PRODUCT } from 'services/product';
...
export default function Index() {
    ...
    const { data, isLoading, refetch } = useQuery('GET_PRODUCTS', GET_PRODUCTS);
    ...
    const onDelete = async () => {
        deleteMutation.mutate({ id: itemSelected.product_id });
    };
