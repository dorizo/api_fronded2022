...
export default function FormStep({ title = 'PO' }) {
    const {
        openFS,
        supplier,
        handleNext,
    ...
    return (
        <Dialog fullWidth maxWidth="lg" open={openFS}>
            <DialogTitle>
                {isDetail ? 'Detail' : po.id ? 'Edit' : 'Buat'} {title}
            </DialogTitle>
            <DialogContent>
                <MainCard>
                            ...
                            <TableBody>
                                {po.items &&
                                    po.items.map((item, index) => {
                                        const { productId, qty, harga, total } = item;
                                        return (
                                ...
                                <TableRow>
                                    ...
                                    <TableCell>{convertToRupiah(po.subTotal)}</TableCell>
                                </TableRow>
                                <TableRow>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell>{convertToRupiah(po.total)}</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </TableContainer>
